...
- **[미작성] 재산세 2기분 납부 1편: 9월 재산세 카드납부·분납 방법 (세금 또는 부동산, 사용자 지정 2026-08-10)** - 근거: 같은 분석에서 재산세 통합 계산기 PV 11→44(4배), holding-tax-guide 네이버 랜딩 10→23, ChatGPT발 종부세 계산기 1→7 상승. 재산세 2기분 납부기간 9/16~9/30 직전이 적기(9월 초 발행 권장). 앵글: 납부 실무(위택스/이택스 납부방법, 250만원 초과 분납, 카드 무이자·포인트 혜택) 중심 - **작성 전 property-tax-guide.html·holding-tax-guide.html의 h2 전수 확인**해 기커버면 청년도약계좌처럼 [기커버] 처리하고 내부링크 보강으로 대체. 납부기간·분납 기준액은 웹서치로 2026년 확정치 검증 필수.
