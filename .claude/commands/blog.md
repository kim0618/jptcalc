...
진행 중인 클러스터가 있으면 **그 위성 주제를 큐에서 먼저 뽑는다.** 클러스터가 없거나 소진되면 Tier 1 승자 중 하나를 새 허브로 삼아 클러스터를 시작한다.

- **현재 클러스터: 연봉(salary)** | 시작 2026-06-01 | 허브: raise-rate-industry(완료)
- **위성 작성 순서:** #7 연봉협상 → #9 시급환산 → #10 3.3% 프리랜서 (+ 기존 salary 글과 내부링크)
- **소진 예정:** ~2026-06-08 | **성과 점검 예정: 2026-07-06** (허브 완성 4주 뒤 → 트리거 B 발동)
- 다음 후보 클러스터: 부동산(보유세 허브 #3, CTR 10% 최강 승자) → 종부세vs재산세·중개수수료·공시가15억
