...
(function(){
  ...
  const pages={
    ...
    '/calc/baby/parental-leave-pay/': {
      ...
      guides:[['/blog/posts/paternity-leave-guide.html','배우자 출산휴가 급여 계산법 2026 - 20일로 확대, 대기업은 왜 정부 지원이 없을까'],['/blog/posts/parental-work-reduction-pay-guide.html','육아기 근로시간 단축급여 계산법 2026 - 상한액 250만원 인상, 육아휴직급여와 다른 점'],['/blog/posts/maternity-leave-pay-guide.html','출산전후휴가급여 계산법 2026 - 육아휴직급여와 다른 점, 상한액 220만원 완전정리'],['/blog/posts/parental-leave-pay.html','육아휴직급여 계산법 2026 - 통상임금 100%·6+6 최대 4,000만원, 매월 실수령액은 얼마일까']]
    }
  };
  let cfg=pages[path];
  if(!cfg){
