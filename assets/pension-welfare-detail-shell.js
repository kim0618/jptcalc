...
(function(){
  ...
  const pages={
    ...
    '/calc/pension-welfare/pension-tax/': {
      ...
      guides:[['/blog/posts/pension-tax-guide.html','연금소득세 완전 정리 - IRP·연금저축 세율·실수령액·절세 전략'],['/blog/posts/national-pension-income-tax.html','국민연금 연금소득세 완전 정리 - 수령액별 실제 세금 계산과 절세 전략'],['/blog/posts/irp-vs-pension-savings.html','IRP vs 연금저축 차이 - 세액공제·인출·수령 세금 완전 비교 2026']]
    },
