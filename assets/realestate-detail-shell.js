...
(function(){
  ...
  const pages={
    ...
    '/calc/realestate/didimdol/': {
      key:'didimdol',
      quick:['소득요건은 부부합산 기준이며, 신생아 특례 2.5억 상향은 백지화되어 1.3억/맞벌이 2억이 현행입니다.','6.27 대책으로 2025.6.28 신규 접수분부터 신생아 5억→4억·일반 2.5억→2억으로 한도가 줄었습니다.','한도는 상품 상한과 주택가×LTV(70~80%) 중 낮은 값으로 정해집니다.','표시 금리는 우대 적용 전 기본금리이며, 다자녀·생애최초·지방 0.2%p 우대로 더 낮아집니다.'],
      related:[['/calc/realestate/dti/','총부채상환비율(DTI)','💵'],['/calc/realestate/ltv/','주택담보인정비율(LTV)','🔑'],['/calc/realestate/loan/','대출이자 계산기','💰']]
    },
    ...
    '/calc/realestate/propertytax/': {
      ...
      guides:[['/blog/posts/property-tax-second-payment-guide.html','재산세 2기분 납부 2026 - 9월 16일~30일, 카드 수수료 0원·250만원 넘으면 분할납부'],['/blog/posts/realestate-tax-timing.html','잔금일 하루 차이로 세금 수백만원 달라진다 - 6월 1일 재산세·종부세 기준일 2026'],['/blog/posts/holding-tax-guide.html','2026 보유세 완전 정복 - 재산세·종부세 합산 실납부액, 공시가 5억~25억 구간 비교'],['/blog/posts/property-tax-guide.html','재산세 - 공시가격 3억원 아파트 총 납부액 57만원, 7월·9월 계산법 2026']]
    },
