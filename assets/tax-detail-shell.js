...
(function(){
  ...
  const pages={
    ...
    '/calc/tax/four-insurance/': {
      key:'four-insurance',
      quick:['2026년 근로자 4대보험 요율: 국민연금 4.75% / 건강보험 3.595% / 장기요양 건강보험료의 13.14% / 고용보험 0.9%.','국민연금에는 상한(659만원)·하한(41만원)이 있어 고소득자도 최대 313,025원만 공제됩니다.','식대 등 비과세 수당은 4대보험 산정 기준에서 제외되어 과세 기준급여를 낮춥니다.','사용자(회사)도 근로자와 동일한 비율로 추가 부담해 총 인건비는 명목 급여보다 약 15~20% 높습니다.'],
