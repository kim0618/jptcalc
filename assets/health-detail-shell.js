...
(function(){
  ...
  const pages={
    '/calc/health/bmi/': {
      ...
      guides:[['/blog/posts/liver-enzyme-guide.html','간수치 정상범위 2026 - AST·ALT·감마지티피 건강검진 판정기준과 수치가 높은 원인'],['/blog/posts/blood-sugar-guide.html','공복혈당 정상수치 2026 - 당화혈색소(HbA1c) 당뇨병 전단계 진단기준'],['/blog/posts/bmi-guide.html','한국인 BMI 기준 - 18.5~22.9 정상, 25 이상 비만 (BMI 21은 정상인가요?)'],['/blog/posts/cholesterol-levels-guide.html','콜레스테롤 정상수치 - LDL·HDL·중성지방 기준과 건강검진 결과 단계별 해석'],['/blog/posts/ideal-weight.html','적정체중 계산법과 건강 체중 관리 전략']]
    },
    '/calc/health/bmr/': {
      key:'bmr',
