...
(function(){
  ...
  const pages={
    ...
    '/calc/auto/ev-charging/': {
      key:'ev-charging',
      quick:['충전비 = 충전 전력량(kWh) × 충전 단가(원/kWh)입니다.','충전 전력량 = 배터리 용량 × (목표% − 현재%) ÷ 100입니다.','2026년 환경부 공공 완속 294.3원/kWh, 초급속 391.9원/kWh(4.30 개편)입니다.','100km 주행 시 전기차(완속)는 약 5,886원으로 휘발유차(약 14,167원)보다 저렴합니다.'],
    ...
    '/calc/auto/ev-subsidy/': {
      key:'ev-subsidy',
      quick:['전기차 보조금 = 국고보조금 + 노후차 전환지원금 + 지자체 보조금입니다.','국고는 차종 등급별 대표액(중·대형 580만·소형 530만)에 차량가격 구간계수를 곱합니다.','차량가격 5,000만 미만 100%·5,000~8,500만 50%·8,500만 이상 0%입니다.','지자체 보조금은 지역·예산별 상이하니 ev.or.kr에서 조회 후 입력하세요.'],
