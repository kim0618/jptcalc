...
(function(){
  ...
  const pages={
    ...
    '/calc/date/date-add/': {
      ...
      guides:[['/blog/posts/consumption-expiry-guide.html','소비기한 계산법 2026 - 유통기한과 뭐가 다른가, 우유는 왜 아직 안 바뀌었나'],['/blog/posts/retirement-age-date-guide.html','정년퇴직일 계산법 2026 - 만 60세 법정 정년, 내 퇴직일은 정확히 언제?'],['/blog/posts/date-add-guide.html','날짜 더하기·빼기 계산법 - 계약 만료일 정확히 계산하기'],['/blog/posts/holiday-2026.html','2026년 공휴일 22일 - 제헌절 부활·노동절 신설과 대체공휴일·황금연휴 총정리']]
    },
    '/calc/date/age/': {
      key:'age',
      ...
      guides:[['/blog/posts/elementary-school-enrollment-guide.html','초등학교 입학연도 계산법 2026 - 취학통지서 시기와 조기입학·입학연기 신청 기한'],['/blog/posts/hwangap-chilsun-age-guide.html','환갑 나이 계산법 2026 - 육순과 헷갈리면 1년 차이 납니다'],['/blog/posts/korean-age-system.html','만 나이 통일법 완벽 정리 - 2023년 이후 달라진 것들'],['/blog/posts/military-discharge-date.html','전역일 계산법 - 복무 기간별 전역 예정일 확인']]
    },
    '/calc/date/weekday/': {
      key:'weekday',
  ...
  left.innerHTML=(window.JPT_sidebarLeft?window.JPT_sidebarLeft('date', cfg.key):'');
