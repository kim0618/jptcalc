...
window.AI_MODELS = {
  gpt54:         { name: 'GPT-5.4',           input: 2.50,  output: 15.00, ctx: '1M',   coding: 91, reasoning: 91 },
  gpt54mini:     { name: 'GPT-5.4 mini',       input: 0.75,  output:  4.50, ctx: '400K', coding: 82, reasoning: 80 },
  claude4opus:   { name: 'Claude Opus 4.8',    input:  5.00, output: 25.00, ctx: '1M',   coding: 95, reasoning: 96 },
  claude4sonnet: { name: 'Claude Sonnet 4.6',  input:  3.00, output: 15.00, ctx: '1M',   coding: 92, reasoning: 90 },
  ...
  gemini2flash:  { name: 'Gemini 2.5 Flash',   input: 0.30,  output:  2.50, ctx: '1M',   coding: 80, reasoning: 77 },
};
...
// 데이터 확인 기준일
window.AI_MODELS_UPDATED = '2026-06-09';
